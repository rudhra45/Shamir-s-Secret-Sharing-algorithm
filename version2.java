...
public class version2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Second test case
            FileInputStream inputStream2 = new FileInputStream("test3.json");
            ...
            BigInteger secret2 = lagrangeInterpolationAtX(xValsForInterpolation, yValsForInterpolation, BigInteger.ZERO,
                    MODULUS);
            System.out.println("Secret (Test Case 3): " + secret2);
            ...
            if (wrongPoints.isEmpty()) {
                System.out.println("No wrong points found in Test Case 3.");
            } else {
                System.out.println("Wrong points in Test Case 3: " + wrongPoints);
            }
